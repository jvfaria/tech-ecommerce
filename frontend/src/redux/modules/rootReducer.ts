...
import { INITIAL_STATE as avatarUploadInitialState, HANDLERS as AVATAR_UPLOAD_HANDLERS } from './UploadAvatar/ducks/index';
import { INITIAL_STATE as loadingInitialState, HANDLERS as LOADING_HANDLERS } from './Loading/ducks/index';
...
export default combineReducers({
  ...
  avatar: createReducer(avatarUploadInitialState, AVATAR_UPLOAD_HANDLERS),
  loading: createReducer(loadingInitialState, LOADING_HANDLERS),
});
